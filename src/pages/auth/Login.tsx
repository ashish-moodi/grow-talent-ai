            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <Link
                  ...
                  className="text-sm text-primary hover:text-primary/80 transition-luxury"
                >
                  Forgot password?
                </Link>
              </div>
              ...
              <Button
                type="submit"
                className="w-full bg-gradient-luxury hover:opacity-90 text-white font-medium transition-luxury"
              >
                Sign In
              </Button>
            </form>
